...
<div class="py-6">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
                ...
                <ol class="flex items-center space-x-4">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <span class="ml-4 text-sm font-medium text-gray-900">Create Distributor</span>
                        </div>
                    </li>
                </ol>
            </nav>
            ...
            <div class="mt-4">
                <h1 class="text-3xl font-bold text-gray-900">Create New Distributor</h1>
                <p class="text-gray-600">Add a new supplier or distributor to your system</p>
            </div>
        </div>

        <!-- Form -->
        <div class="bg-white shadow rounded-lg">
            <form method="POST" action="{{ route('distributors.store') }}" class="space-y-6 p-6">
                @csrf
